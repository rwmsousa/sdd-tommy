...
8. Invoke the `makuco-prd-generator` skill (~/.claude/skills/makuco-prd-generator/SKILL.md) to produce the final PRD.
...
- `makuco-prd-generator` (~/.claude/skills/makuco-prd-generator/SKILL.md): invoke after requirements are defined to produce the final PRD.
