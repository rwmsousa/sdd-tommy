...
### Naming Conventions
- Follow the project's existing naming conventions (check `.makuco/codebase/conventions.md`).
...
> **Note**: Always check `.makuco/codebase/conventions.md` for project-specific overrides to these general practices.
